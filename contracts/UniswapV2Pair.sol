...
contract UniswapV2Pair is IUniswapV2Pair, UniswapV2ERC20 {
    ...
    uint public constant MINIMUM_DEPOSIT = 30;
    ...
    function mintCharacter(uint256 amount0In, uint256 amoun1In) internal {
        ...
        uint256 value = price0 / priceFeed0.decimals() * amount0In + price1 / priceFeed1.decimals() * amount1In;
    ...
    function initialize(address _token0, address _token1, address _nftFactory) external {
