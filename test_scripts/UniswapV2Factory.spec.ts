...
describe('DefiWarriorFactory', () => {
  ...
  async function createPair(tokens: [string, string]) {
    const bytecode = `0x${DefiWarriorPair.evm.bytecode.object}`
    ...
    const pair = new Contract(create2Address, JSON.stringify(DefiWarriorPair.abi), provider)
